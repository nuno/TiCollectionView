...
public class DefaultCollectionViewTemplate extends CollectionViewTemplate {

	public DefaultCollectionViewTemplate(String id, KrollDict properties, Activity activity) {
		super(id, properties);
