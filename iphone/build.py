...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','de.marcelpociot.collectionview.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','DeMarcelpociotCollectionviewModuleAssets.m')
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','grid.png','waterfall.png','contextmenu.gif']
