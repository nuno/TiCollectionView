...
- (NSDictionary *)overrideEventObject:(NSDictionary *)eventObject forEvent:(NSString *)eventType fromViewProxy:(TiViewProxy *)viewProxy
{
	...
	[updatedEventObject setObject:NUMUINTEGER(_indexPath.section) forKey:@"sectionIndex"];
	[updatedEventObject setObject:NUMUINTEGER(_indexPath.row) forKey:@"itemIndex"];
